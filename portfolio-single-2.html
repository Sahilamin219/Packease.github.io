...
<div class="arlo_tm_wrapper_all">
	...
	<div class="arlo_tm_mobile_header_wrap">
		...
		<div class="arlo_tm_mobile_menu_wrap">
   			<div class="mob_menu">
				<ul class="anchor_nav">
					<li><a href="http://frenify.com/envato/marketify/html/arlo/1/#home">Home</a></li>
					<li><a href="http://frenify.com/envato/marketify/html/arlo/1/#about">About</a></li>
					<li><a href="http://frenify.com/envato/marketify/html/arlo/1/#services">Services</a></li>
					<li><a href="http://frenify.com/envato/marketify/html/arlo/1/#portfolio">Portfolio</a></li>
					<li><a href="http://frenify.com/envato/marketify/html/arlo/1/#news">News</a></li>
					<li><a href="http://frenify.com/envato/marketify/html/arlo/1/#contact">Contact</a></li>
				</ul>
			</div>
		</div>
	</div>
								...
								<div class="short_list">
									<ul>
										<li>
											...
											<span class="second">Branding</span>
										</li>
										<li>
